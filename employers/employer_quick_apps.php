        ...
        <div id="contents" style="padding-top: 10px;" class="col-md-9 col-sm-9 col-xs-9">
            <div id="tab" class="row">
                <ul class="nav nav-tabs">
                    ...
                    <li class="active" style="font-weight: bold;"><a href="employer_apps.php">Non-Member's Applications</a></li>
                </ul>
            </div>
            <div id="search_job" style="height: 30px;" class="row">
                ...
                <button class="btn btn-default pull-right" disabled="disabled">Total Applications <span class="badge"><?php echo countQUICKEmployerApps($comp_id); ?></span></button>
            </div>
            <?php
               ...
               <div class="table-responsive"> 
                <table class="table table-bordered table-condensed">
                    ...
                    <tr class="active">
                        ...
                        <th style="width: 25%;">Applicant Email</th>
                    ...
                    $statement = "quick_apply WHERE comp_id = '$comp_id' ORDER BY apply_date DESC"; // Change `records` according to your table name.
                    ...
                    while($row_jobs = mysqli_fetch_array($results)){
                            ...
                            $job_id = $row_jobs['job_id'];
                       		$first_name = $row_jobs['first_name'];
							$last_name = $row_jobs['last_name'];
                    ...
                    <tr>
                        ...
                        <td>
							<span style='font-weight: bold;'><?php echo $first_name . "&nbsp;" . $last_name; ?></span><br/>
                            <?php 
								if($pak_city == "-1"){
									echo $other_city . " , " . $crty_name;	
								}else{
                        ...
                        <td align="center">
                        <a href="view_empl_quick_application.php?apply_id=<?php echo $apply_id; ?>" style="line-height: 25px;"><button class="btn btn-success btn-xs" style="width: 84px;" title="Application Tracking..."><span class="glyphicon glyphicon-flash"></span>Action</button></a>
                        <a href="employer_quick_job_notes.php?apply_id=<?php echo $apply_id; ?>"><button class="btn btn-success btn-xs"><span class="glyphicon glyphicon-pencil"></span> Add Notes</button></a>
                        </td>
                    </tr>
                    ...
                    <?php
						if($emp_notes != ""){
							echo "<tr>
								...
								<td colspan='6'><label style='color: #F00;'>Notes:</label> <span style='color: #00F;'>$emp_notes</span><a href='delete_quick_note.php?apply_id=$apply_id'><button type='button' class='close' style='margin-right: 5px;' title='Delete Notes...'> &times; </button></a></td>
							</tr>";
						}
						else{
						}
