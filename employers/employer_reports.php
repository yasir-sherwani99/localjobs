    ...
    <div id="contents" style="padding-top: 10px;" class="col-md-9 col-sm-9 col-xs-9">
    	<div id="tab" class="row">
        	<ul class="nav nav-tabs">
            	<li class="active" style="font-weight: bold;"><a href="#">Quick Stats</a></li>
        ...
        <div id="all_jobs" style="height: 350px; background-color:#FFF; font-size: 14px;" class="row">
          <div class="table-responsive">
                <table border="0" class="table table-bordered" style="width: 50%">
                <tr>
                	<td colspan="2" style="color: #F00;">Quick Stats</td>
                </tr>
                <tr>
                    <td style="color: #0080FF;">Current live jobs</td>
                    <td style="text-align: center;"><span class="badge num"><?php echo currentliveJobs($comp_id); ?></span></td>
                </tr>
                
                <tr>
                    <td style="color: #0080FF;">Jobs posted this month</td>
                    <td style="text-align: center;"><span class="badge num"><?php echo currentmonthJobs($comp_id); ?></span></td>
                </tr>
                <tr>
