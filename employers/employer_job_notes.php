            ...
            <div id="all_jobs" style="background-color:#FFF; font-size: 14px;" class="row">
               <div class="table-responsive"> 
                <table class="table table-bordered">
                	<form action="employer_job_notes.php?edit_form=<?php echo $applyId; ?>" role="form" method="post">
...
<?php
	if(isset($_POST['add_notes'])){
		...
		if($run_notes){
			...
			echo "<script>window.open('employer_apps.php?updated=You have successfully added notes to application...', '_self')</script>";
		}
		else{
