<form method="post" role="form" action="result.php" onSubmit="return confirmSubmit()">
...
<tr>
	<td><b>Key Skills/Requirements</b><span style="color: #F00; font-size: 16px;">&nbsp;*</span></td>
    <td>
    	<textarea name="skills" id="skills" cols="50" rows="3" class="form-control" onBlur="jobSkills()"></textarea>
...
<tr>
  ...
  <tr>
    <td class="form_side_title"><b>Country</b><span style="color: #F00;">*</span></td>
    <td class="field">
  ...
  <tr id="pak_location">
	<td class="form_side_title"><b>City</b><span style="color: #F00;">*</span></td>
    <td>
  ...
  <tr id="other_loc">
	<td class="form_side_title"><b>City Name:</b><span style="color: #F00; font-size: 16px;">&nbsp;*</span></td>
    <td>
    	<input type="text" name="other_city" id="other_city" class="form-control" onBlur="otherjobCity()" />
    </td>
...
<tr>
	<td></td>
	<td>
        <input type="submit" name="submit" id="submit" class="btn btn-default" value="Publish &raquo;" />
    </td>
    <td></td>
</tr>
</tbody>
