<form name="" action="emp_register.php" method="post" role="form" onSubmit="return confirmSubmit1()">
...
<!--            <tr>
          ...
          <tr id="pak_location">
            <td style="padding-left: 10px;">City<span class="red_sterik">&nbsp;*</span></td>
            <td>
                <select name="comp_loc" id="location" class="form-control" onBlur="cityCheck()">
                    <option value="-1">Select City</option>
                    <?php
          ...
          <tr id="other_loc">
            <td style="padding-left: 10px;">City Name:<span class="red_sterik">&nbsp;*</span></td>
            <td>
                <input type="text" name="other_city" id="other_city" class="form-control" onBlur="othercityCheck()" />
            </td>
            <td id="error11" class="empl_errors"></td>
          </tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <span class="help-block">You can enter linkedin or facebook url of your company...</span>
                </td>
