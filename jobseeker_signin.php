	...
	<div id="contents" style="font-family:Trebuchet MS;" class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div id="job_details" style="height: 400px;" class="row">
                    ...
                    <div class="panel-body">
                        <form method="post" action="jobseeker_signin.php" role="form">
...
<?php
	...
	if($check_user > 0){
		...
		echo "<script>window.open('jobseeker_signin.php?mess1=Username or Password is Incorrect, Please try again...','_self')</script>";
	}
