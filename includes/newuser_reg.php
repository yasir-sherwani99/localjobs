<form name="passcheck" method="post" action="members_register.php" enctype="multipart/form-data" role="form" onSubmit="return confirmSubmit1()">
...
<table class="table table-striped table-bordered">
  ...
  <tr>
    <td class="form_side_title" style="width: 120px;">Email<span style="color: #F00;">*</span></td>
    <td class="field">
    <input type="email" name="m_email" id="email" placeholder="Register your current email address." class="form-control" />
    </td> 
    <td style="width: 200px;"><span class="error_mess" id="error"></span></td>
  </tr>
  
  <tr>
    <td class="form_side_title">Password<span style="color: #F00;">*</span></td>
    <td class="field">
    <input type="password" name="m_pass" id="m_pass" class="form-control" placeholder="Password" onBlur="emptyCheck()"/>
    </td>
    <td><span class="error_mess" id="error1">&nbsp;</span></td>
  </tr>
  
  <tr>
    <td class="form_side_title">Confirm Password<span style="color: #F00;">*</span></td>
    <td class="field">
    <input type="password" name="m_pass1" id="m_pass1" class="form-control" placeholder="Confirm Password" onBlur="checkPass()"/>
    </td>
  ...
  <tr>
    <td class="form_side_title">First Name<span style="color: #F00;">*</span></td>
    <td class="field">
    <input type="text" name="f_name" id="f_name" placeholder="Mention your first name" class="form-control" onBlur="fNameCheck()"/>
    </td>
    <td><span class="error_mess" id="error3">&nbsp;</span></td>
  </tr>
  
  <tr>
    <td class="form_side_title">Last Name<span style="color: #F00;">*</span></td>
    <td class="field">
    <input type="text" name="l_name" id="l_name" placeholder="Mention your last name" class="form-control" onBlur="lNameCheck()"/>
    </td>
    <td><span class="error_mess" id="error4">&nbsp;</span></td>
  </tr>
  
  <tr>
    <td class="form_side_title">Gender<span style="color: #F00;">*</span></td>
    <td class="field" style="font-size: 14px;">
    	<input type="radio" name="m_gender" id="m_gender" value="Male" onClick="genderCheck()"/>&nbsp;Male
        <input type="radio" name="m_gender" id="m_gender" value="Female" onClick="genderCheck()" />&nbsp;Female 
    </td>
    <td><span class="error_mess" id="error5">&nbsp;</span></td>
  </tr>
  
  <tr>
    <td class="form_side_title">Date of Birth<span style="color: #F00;">*</span></td>
    <td class="field">
    	<select name="dob_day" id="dob_day" class="form_drop_down_menu" onBlur="checkDOB()">
        ...
        <select name="dob_month" id="dob_month" class="form_drop_down_menu" onBlur="checkDOB()">
        ...
        <select name="dob_year" id="dob_year" class="form_drop_down_menu" onBlur="checkDOB()">
  ...
  <tr>
    <td class="form_side_title">Country<span style="color: #F00;">*</span></td>
    <td class="field">
        <select name="m_ctry" id="m_ctry" class="form-control" onBlur="ctryCheck()">
  ...
  <tr id="pak_location">
	<td class="form_side_title">City<span style="color: #F00;">*</span></td>
    <td>
    	<select name="location" id="location" class="form-control" onBlur="cityCheck()">
  ...
  <tr id="other_loc">
	<td class="form_side_title">City Name:</td>
    <td>
    	<input type="text" name="other_location" id="other_location" class="form-control" onBlur="othercityCheck()" />
    </td>
    <td><span class="error_mess" id="error31">&nbsp;</span></td>
  </tr>
	  
  <tr>
    <td class="form_side_title">Mobile Phone<span style="color: #F00;">*</span></td>
    <td class="field">
    <input type="text" name="m_mobile" id="m_mobile" maxlength="12" placeholder="Example: 03211234567" class="form-control" onBlur="mobileCheck()"/>
    </td>
    <td><span class="error_mess" id="error8">&nbsp;</span></td>
  </tr>
  
  <tr>
    <td class="form_side_title">Home Phone:</td>
    <td class="field">
  ...
  <tr>
    <td class="form_side_title">Higest Degree<span style="color: #F00;">*</span></td>
    <td class="field">
    	<select name="m_edu_level" id="m_edu_level" class="form-control" onBlur="degreeCheck()">
  ...
  <tr class="hide_edu_details">
    <td class="form_side_title">Degree Title<span style="color: #F00;">*</span></td>
    <td class="field">
    <input type="text" name="degree_title" id="degree_title" placeholder="Example: B.Sc (Hon's) in Computer Science" class="form-control" onBlur="degreeTitleCheck()" />
    </td>
    <td><span class="error_mess" id="error11">&nbsp;</span></td>
  </tr>
  
  <tr class="hide_edu_details">
    <td class="form_side_title">Major Subject(s)<span style="color: #F00;">*</span></td>
    <td class="field">
    	<input type="text" name="majors" id="majors" class="form-control" onBlur="majorsCheck()" />
    </td>
    <td><span class="error_mess" id="error12">&nbsp;</span></td>
  </tr>
  
  <tr class="hide_edu_details">
    <td class="form_side_title">Institution<span style="color: #F00;">*</span></td>
    <td class="field">
    	<input type="text" name="institute_name" id="institute_name" class="form-control" onBlur="eduInsCheck()"/>
    </td>
  ...
  <tr class="hide_edu_details">
    <td class="form_side_title">City<span style="color: #F00;">*</span></td>
    <td class="field">
    	<input type="text" name="institute_city" id="institute_city" class="form-control" onBlur="educityCheck()" />
    </td>
  ...
  <tr class="hide_edu_details">
  	<td class="form_side_title">Country<span style="color: #F00;">*</span></td>
    <td class="field">     
         <select name="institute_ctry" id="institute_ctry" class="form-control" onBlur="eductryCheck()">
         <option value="-1">Select Country</option>
         <?php
			$get_ctry = "select * from countries ORDER BY ctry_name";
			$run_ctry = mysqli_query($connection, $get_ctry);
  ...
  <tr class="hide_edu_details">
    <td class="form_side_title">Completion Year<span style="color: #F00;">*</span></td>
    <td class="field">
        <select name="complete_year" id="complete_year" class="form-control" onBlur="eduyearCheck()">
  ...
  <tr>
    <td class="form_top_title" colspan="3">Professional Summary</td>
  </tr>
  
  <tr>
    <td class="form_side_title">Professional Industry<span style="color: #F00;">*</span></td>
    <td class="field">
  ...
  <tr>
    <td class="form_side_title">Work Experience?<span style="color: #F00;">*</span></td>
    <td class="field">
    	<select name="experience" id="experience" onBlur="expCheck()" class="form-control"> 
        	<option value="-1">Select</option>
            <option value="Yes">Yes</option>
            <option value="No">No</option>
        </select>
    </td>
    <td style="vertical-align: top;"><span class="error_mess" id="error16">&nbsp;</span></td>
  </tr>
  
  <tr class="exp_hide">
    <td class="form_side_title">Total Experience<span style="color: #F00;">*</span></td>
    <td class="field">
    	<select name="m_exp_year" id="m_exp_year" class="form_drop_down_menu" onBlur="jobexpCheck()">
        ...
        <select name="m_exp_month" id="m_exp_month" class="form_drop_down_menu" onBlur="jobexpCheck()">
  ...
  <tr class="exp_hide">
    <td class="form_side_title">First Job Start Date<span style="color: #F00;">*</span></td>
    <td class="field">
        <select name="job_start_day" id="job_start_day" class="form_drop_down_menu" onBlur="firstjobDate()">
			<option value="-1">Day</option>
            <?php
        ...
        <select name="job_start_month" id="job_start_month" class="form_drop_down_menu" onBlur="firstjobDate()">
			<option value="-1">Month</option>
            <?php
        ...
        <select name="job_start_year" id="job_start_year" class="form_drop_down_menu" onBlur="firstjobDate()">
			<option value="-1">Year</option>
            <?php
  ...
  <tr class="exp_hide">
    <td class="form_side_title">Current Job Title:</td>
    <td class="field">
  ...
  <tr class="exp_hide">
    <td class="form_side_title" style="vertical-align: middle;">Job Period</td>
    <td>
    ...
    <td><span class="error_mess" id="error21">&nbsp;</span></td>
  </tr>
  
  <tr class="exp_hide">
    <td class="form_side_title">Company Name:</td>
    <td class="field">
  ...
  <tr class="exp_hide">
    <td class="form_side_title">Country:</td>
    <td class="field">
  ...
  <tr class="exp_hide">
    <td class="form_side_title">City:</td>
    <td class="field">
  ...
  <tr>
    <td colspan="3" class="form_top_title">Looking For</td>
  </tr>
  <tr>
    <td class="form_side_title">Prefered Job<span style="color: #F00;">*</span></td>
    <td class="field">
    	<input type="text" name="prefer_job" id="prefer_job" placeholder="e.g. Software Engineer, Sales Manager etc" class="form-control" onBlur="preferjobCheck()"/>
    </td>
    <td><span class="error_mess" id="error33">&nbsp;</span></td>
  </tr>
  <tr>
    <td class="form_side_title">Prefered Job Location</td>
    <td class="field">
        <select name="prefer_job_loc" id="prefer_job_loc" class="form-control">
        	<option value="-1">Select City</option>
            <?php
				$get_city = "select * from city order by city_name";
				$run_city = mysqli_query($connection, $get_city);
    ...
    <td><span class="error_mess" id="error34">&nbsp;</span></td>
  </tr>
  <tr>
    <td class="form_side_title">Salary Expectations</td>
    <td class="field">
    	<select name="salary_exp" id="salary_exp" class="form_drop_down_menu">
        	<option value="-1">Select Salary</option>
            <?php
				$get_sal = "select * from salary order by sal_sal";
         ...
         <span style="font-size: 14px;" class="label label-success">PKR</span>
    </td>
    <td><span class="error_mess" id="error32">&nbsp;</span></td>
  </tr>
  <tr>
  ...
  <tr>
    <td class="form_side_title">Resume Headline<span style="color: #F00;">*</span></td>
    <td class="field">
    	<input type="text" name="cv_headline" id="cv_headline" placeholder="Make your Resume Headline Work" class="form-control" onBlur="resumeCheck()"/>
        <span class="help-block">e.g. Software Engineer, Sales Manager, Sciene Teacher etc</span>
    </td>
    <td><span class="error_mess" id="error25">&nbsp;</span></td>
  </tr>
  
  <tr>
    <td class="form_side_title">Upload CV or Resume<span style="color: #F00;">*</span></td>
    <td class="field">
    	<input type="file" name="m_cv" id="m_cv" class="form-control" />
        <span class="help-block">Upload file only in .doc, .docx or pdf format.</span>
    </td>
