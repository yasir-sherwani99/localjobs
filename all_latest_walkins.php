         ...
         <div id="contents" class="row">
            ...
            <div id="alljobs_leftside" class="col-md-3 col-sm-3 hidden-xs">
				...
				<?php
                    				...
                    				$run_city = mysqli_query($connection, $top_city);
                    
                    				while($row_top = mysqli_fetch_array($run_city)){
            ...
            <div id="all_jobs" class="col-md-9 col-sm-9 col-xs-12">
                <h1>Latest Walkin Interviews in Pakistan</h1>
          
                 <h2><?php echo countTotalWalkin() . " Jobs found"; ?></h2>
                <?php include("includes/all_latest_walkin.php"); ?>
            </div>
       </div>
