          ...
          <div class="table-responsive">	
        	<table border="0" class="table table-bordered">
                ...
                <tr>
                    ...
                    <td><?php echo countEmployerJobs($comp_id); ?></td>
                    <td><a href="edit_employer.php?comp_id=<?php echo $comp_id; ?>"><button class="btn btn-default btn-xs"><img src="images/pencil.png" width="10" height="10"></button></a></td>
                    <td><a href="delete_employer.php?comp_id=<?php echo $comp_id; ?>" onClick="return confirm('Are you sure, you want to delete this Job??')"><button class="btn btn-default btn-xs"><img src="images/cross.png" width="10" height="10"></button></a></td>
                </tr>
