    ...
    <div id="contents" class="col-md-9">
    	<div id="tab" class="row">
        	<ul class='nav nav-tabs'>
                ...
                <li class="active" style="font-weight: bold;"><a href="opt_cat.php">Categories</a></li>
        ...
        <div id="search_job" style="background-color: #FFF; height: 30px; border: hidden;" class="row">
        	<a href="add_cat.php"><button class="btn btn-default pull-left">Add +</button></a>
            <button class="btn btn-default pull-right" disabled="disabled">Total Categories: <span class="badge"><?php echo totalCategory(); ?></span></button>
        </div>
        <?php
        ...
        <div id="all_jobs" style="background-color:#FFF; font-size: 14px;" class="row">
        	...
        	<table border="0" class="table">
				...
				$statement = "categories ORDER BY cat_title"; // Change `records` according to your table name.
                ...
                <tr>
                    ...
                    <td>Active</td>
                    <td><a href="edit_cat.php?cat_id=<?php echo $cat_id; ?>"><button class="btn btn-default btn-xs"><img src="images/pencil.png" width="10" height="10"></button></a></td>
                    <td><a href="delete_cat.php?cat_id=<?php echo $cat_id; ?>" onClick="return confirm('Are you sure, you want to delete this Category??')"><button class="btn btn-default btn-xs"><img src="images/cross.png" width="10" height="10"></button></a></td>
                </tr>
                </tbody>
