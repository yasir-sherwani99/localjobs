    ...
    <div id="contents" class="col-md-9">
    	<div id="tab" class="row">
        	<ul class='nav nav-tabs'>
                ...
                <li class="active" style="font-weight: bold;"><a href="opt_cat.php">Add Category</a></li>
        ...
        <?php
			if(isset($_GET['mess'])){
				...
				echo "<div id='message' class='alert alert-info'>
        				<img src='images/info.png' width='45' height='45'/>
            		  <div id='aa'><b>Add new category</b><br/>Enter the required fields and add a new category.						</div>
        		</div>";
			}
        ?>
        <div id="job_form" class="row">
        	<form name="" action="add_cat.php" method="post" role="form">
            	<table border="0" class="table">
                <tbody>
				<tr>
					<td>Category Title<span style="color: #F00; font-size: 16px;">&nbsp;*</span></td>
    				<td><input type="text" name="title" class="form-control" required/></td>
				</tr>
                <tr>
                	<td></td>
                    <td><input type="submit" name="submit" class="btn btn-default" value="Add Category" /></td>
                </tr>
                </tbody>
				</table>
            </form>
...
<?php
	if(isset($_POST['submit'])){
		...
		if($run_cat){
			echo "<script>window.open('add_cat.php?mess=A new category has entered successfully...!', '_self')</script>";
		}else{
