    ...
    <div id="contents" class="col-md-9">
    	<div id="tab" class="row">
        	<ul class="nav nav-tabs">
                ...
                <li class="active" style="font-weight: bold;"><a href="opt_ctry.php">Countries</a></li>
                <li><a href="change_pass.php">Change Password</a></li>
            </ul>
        </div>
        <div id="search_job" style="background-color: #FFF; height: 30px; border: hidden;" class="row">
        	<a href="add_ctry.php"><button class="btn btn-default pull-left">Add +</button></a>
            <button class="btn btn-default pull-right" disabled="disabled">Total Countries: <span class="badge"><?php echo totalCtry(); ?></span></button>
        </div>
        <?php
        ...
        <div id="all_jobs" style="background-color:#FFF; font-size: 14px;" class="row">
        	...
        	<table border="0" class="table">
				...
				$statement = "countries ORDER BY ctry_name"; // Change `records` according to your table name.
				...
				$i = 1;
				while($row_ctry = mysqli_fetch_array($results)){
                ...
                <tr>
                    ...
                    <td>Active</td>
                    <td><a href="edit_ctry.php?ctry_id=<?php echo $ctry_id; ?>"><button class="btn btn-default btn-xs"><img src="images/pencil.png" width="10" height="10"></button></a></td>
                    <td><a href="delete_ctry.php?ctry_id=<?php echo $ctry_id; ?>" onClick="return confirm('Are you sure, you want to delete this Country??')"><button class="btn btn-default btn-xs"><img src="images/cross.png" width="10" height="10"></button></a></td>
                </tr>
                </tbody>
