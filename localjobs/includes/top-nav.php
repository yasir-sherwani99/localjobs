    ...
    <ul>
        ...
        <?php 
				if(isset($_SESSION['username'])){
						echo "<li class='no-sub'><a class='top-heading' href='my_account.php'>Dash Board</a></li>";
				}else{
						echo "<li class='no-sub'><a class='top-heading' href='jobseeker_signin_db.php'>Dash Board</a></li>";
				}    
		?>  
