<form name="passcheck" method="post" action="members_register.php" enctype="multipart/form-data" class="form-horizontal" role="form" onSubmit="return confirmSubmit()">
<table class="table table-striped">
  ...
  <tr>
    ...
    <td class="field">
    <input type="password" name="m_pass" id="m_pass" class="form-control" placeholder="Password" onBlur="return emptyCheck()"/>
    </td>
  ...
  <tr align="left">
  	<td></td>
    <td class="field">
    	<input type="submit" class="btn btn-warning btn-block" name="register" value="Join LocalJobs" onClick="cvuploadCheck()"/>
    </td>
    <td></td>
  </tr>
