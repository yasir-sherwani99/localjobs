...
<tr>
    ...
    <td>
    	<textarea name="desc" cols="50" rows="10" class="form-control" required>
        <?php echo $desc; ?>
        </textarea>
...
<tr>
    ...
    <td>
    	<textarea name="skills" cols="50" rows="3" class="form-control" required>
        <?php echo $skills; ?>
        </textarea>
...
<tr>
    ...
    <td><input type="text" name="contact_no" class="form-control" required value="<?php echo $contact_no; ?>"/></td>
</tr>
<tr>
