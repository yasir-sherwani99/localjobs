<?php
	...
	function getProfilePic(){
			...
			if(isset($_SESSION['username'])){
				...
				if($member_pic == ""){
					echo "<img src='images/icons2/administrator.png' width='100' height='100' />";
				}else{
				echo "<img src='members/member_photos/$member_pic' width='100' height='100'/>";
				}
		...
		function getProfileNames(){
			...
			if(isset($_SESSION['username'])){
				...
				if($mem_city == "28"){	
				echo "<table border='0' style='margin-top: 15px; width: auto;'>
					  <tr>	
					  	<td colspan='2' style='color: #3333FF;'>{$member_first}&nbsp;{$member_last}</td>
					  </tr>
					  <tr>	 
					  	<td colspan='2' style='font-size: 12px; font-weight: bold;'>{$current_job}, {$comp_name}</td>
					  </tr>
					  <tr>	
					  	<td colspan='2' style='font-size: 12px;'>{$other_city}, {$ctry_name} | {$cat_name}</td>
					  </tr>
					  <tr>	
					  	<td colspan='2'>&nbsp;</td>
					  </tr>
					   <tr>	
						...
						<td style='font-size: 12px;'>{$member_email}</td>
					  </tr>
					   <tr>	
					  	<td style='font-size: 12px; font-weight: bold;'>Mobile:</td>
						<td style='font-size: 12px;'>{$member_cell}</td>
					  </tr>
				</table>";
				}
				else{
					echo "<table border='0' style='margin-top: 15px; width: auto;'>
					  ...
					  <tr>	
					  	<td colspan='2' style='font-size: 12px;'>{$city_name}, {$ctry_name} | {$cat_name}</td>
					  </tr>
					  <tr>	
					  	<td colspan='2'>&nbsp;</td>
					  </tr>
