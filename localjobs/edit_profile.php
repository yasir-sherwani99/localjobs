                ...
                <tbody>
                   ...
                   <tr class="edit_personal_info">
                    ...
                    <tr class="edit_personal_info">
                    	<td class="title2"></td>
                        <td class="output">
 							<input type="submit" name="update_info" class="btn btn-success btn-xs" value="Save">
                        </td>
                    </tr>
					</form>
                    <?php
					...
					<tr class="edit_mem_summary">
                    	<td class="title2"></td>
                        <td class="output">
 							<input type="submit" name="update_summary" class="btn btn-success btn-xs" value="Save">
                        </td>
                    </tr>
					</form>
                    <?php
                    ...
                    <tr class="edit_mem_qual">
                    	<td class="title2">Qualification</td>
                        <td class="output"><input type="text" name="qual" class="edit_fields" value="<?php echo $mem_degree_title; ?>"></td>
                    </tr>
                    <tr class="edit_mem_qual">
                    	<td class="title2">Specialization/Majors</td>
                        <td class="output">
					...
					<tr class="edit_mem_qual">
                    	<td class="title2"></td>
                        <td class="output">
 							<input type="submit" name="update_qual" class="btn btn-success btn-xs" value="Save">
                        </td>
                    </tr>
					</form>
					<?php
                    ...
                    <tr class="edit_mem_skills">
                    	<td class="title2">IT Skills</td>
                        <td class="output"><input type="text" name="itskills" class="edit_fields" value="<?php echo $mem_it_skills; ?>"></td>
                    </tr>
					<tr class="edit_mem_skills">
                    	<td class="title2">Other Skills</td>
                        <td class="output"><input type="text" name="otherskills" class="edit_fields" value="<?php echo $mem_other_skills; ?>"></td>
                    </tr>
					<tr class="edit_mem_skills">
                    	<td class="title2"></td>
                        <td class="output">
 							<input type="submit" name="update_skills" class="btn btn-success btn-xs" value="Save">
                        </td>
                    </tr>
					</form>
                    <?php
