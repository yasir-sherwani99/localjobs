    ...
    <div id="contents" class="col-md-9">
    	<div id="tab" class="row">
        	<ul class="nav nav-tabs">
                ...
                <li class="active" style="font-weight: bold;"><a href="opt_ctry.php">Edit Country</a></li>
        ...
        <?php
			if(isset($_GET['mess'])){
				...
				echo "<div id='message' class='alert alert-info'>
        				<img src='images/info.png' width='45' height='45'/>
            		  <div id='aa'><b>Update Country</b><br/>Edit the required fields and update a country.						</div>
        		</div>";
			}
        ?>
        <div id="job_form" class="row">
        	<?php
				$ctryid = @$_GET['ctry_id'];
				$get_ctry = "SELECT * FROM countries WHERE ctry_id = '$ctryid'";
            ...
            ?>
        	<form method="post" role="form" action="edit_ctry.php?edit_form=<?php echo $id; ?>">
			<table border="0" class="table">
            <tbody>
			<tr>
				<td>Country Name<span style="color: #F00; font-size: 16px;">&nbsp;*</span></td>
    			<td><input type="text" name="title" class="form-control" value="<?php echo $ctry_name; ?>"/></td>
			</tr>
            <tr>
            	<td></td>
...
<?php
	if(isset($_POST['update'])){
		...
		$ctry_title = cleanStr($_POST['title']);
		
		$update_ctry = "UPDATE countries
					   SET ctry_name = '$ctry_title' 
						   	WHERE ctry_id = '$edit_record'"; 
			
		$run_update = mysqli_query($connection, $update_ctry);
		if($run_update){
			echo "<script>window.open('opt_ctry.php?updated=A country has updated successfully...!', '_self')</script>";
		}else{
