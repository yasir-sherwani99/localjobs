<form method="post" action="edit_foreign.php?edit_form=<?php echo $fjid; ?>" enctype="multipart/form-data" role="form" onSubmit="return foreignConfirm()">
<div class="table-responsive">
<table border="0" class="table table-bordered">
<tbody>
<tr>
	<td style="width: 120px;"><b>Job Title</b><span style="color: #F00; font-size: 16px;">&nbsp;*</span></td>
    <td style="width: 200px;"><input type="text" name="title" id="title" class="form-control" value="<?php echo $fjtitle; ?>"/></td>
    <td style="width: 150px; color: #F00;" id="error1"></td>
</tr>
<tr>
	<td><b>Company Name</b><span style="color: #F00; font-size: 16px;">&nbsp;*</span></td>
    <td>
		<input type="text" name="comp_name" id="comp_name" class="form-control" value="<?php echo $fjcomp; ?>" />
    </td>
...
<tr>
    ...
    <?php
		$get_ctry = "SELECT * FROM countries WHERE ctry_id='$fjctry'";
		$run_ctry = mysqli_query($connection, $get_ctry);
		$row_ctry = mysqli_fetch_array($run_ctry);
			$ctryid = $row_ctry['ctry_id'];
			$ctryname = $row_ctry['ctry_name'];
    ?>	
    <td>
        <select name="job_ctry" id="job_ctry" class="form-control" >
        	<option value="<?php echo $ctryid; ?>"><?php echo $ctryname; ?></option>
        	<?php
...
<tr>
    ...
    <td>
		<input type="text" name="city" id="city" class="form-control" value="<?php echo $fjcity; ?>" />
    </td>
...
<tr>
    ...
    <?php
		$get_cat = "SELECT * FROM categories WHERE cat_id='$fjcat'";
		$run_cat = mysqli_query($connection, $get_cat);
		$row_cat = mysqli_fetch_array($run_cat);
			$catid = $row_cat['cat_id'];
			$catname = $row_cat['cat_title'];
    ?>	
...
<tr>
    ...
    <td>
    	<select name="exp_day" id="exp_day" class="emp_drop_down_menu" onBlur="jobExpiry()">
			<option value="<?php echo $fjexpday; ?>"><?php echo $fjexpday; ?></option>
            <?php
        ...
        <?php
			$get_month = "SELECT * FROM months WHERE month_id='$fjexpmonth'";
			$run_month = mysqli_query($connection, $get_month);
			$row_month = mysqli_fetch_array($run_month);
				$monthid = $row_month['month_id'];
				$monthname = $row_month['month_name'];
    	?>	
        ...
        <select name="exp_year" id="exp_year" class="emp_drop_down_menu" onBlur="jobExpiry()">
			<option value="<?php echo $fjexpyear; ?>"><?php echo $fjexpyear; ?></option>
            <?php
...
<tr>
    ...
    <td>
    	<select name="emp_type" id="emp_type" class="form-control" onBlur="jobEmployment()">
            <option value="<?php echo $fjtype; ?>"><?php echo $fjtype; ?></option>
            <?php
...
<tr>
    ...
    <td>
    	<textarea name="desc" id="desc" cols="50" rows="10" class="form-control" ><?php echo $fjresp; ?></textarea>
      <!--  <script>
...
<tr>
    ...
    <td>
    	<textarea name="require" id="require" cols="50" rows="10" class="form-control" onBlur="jobDesc()"><?php echo $fjreq; ?></textarea>
      <!--  <script>
			CKEDITOR.replace('desc')
		</script> -->
        <span class="help-block">(You may enter upto 5,000 characters)</span>
...
<tr>
    ...
    <td>
    	<textarea name="compen" id="compen" cols="50" rows="10" class="form-control"><?php echo $fjbenefit; ?></textarea>
      <!--  <script>
			CKEDITOR.replace('desc')
		</script> -->
...
<tr>
    ...
    <td>
    	<textarea name="addr" id="addr" cols="50" rows="4" class="form-control"><?php echo $fjaddr; ?></textarea>
      <!--  <script>
			CKEDITOR.replace('desc')
		</script> -->
    </td>
...
<tr>
	<td><b>Phone</b></td>
    <td>
    	<input type="text" name="phone" id="phone" class="form-control" value="<?php echo $fjphone; ?>"/>
    </td>
    <td id="error12" style="color: #F00;"></td>
</tr>
<tr>
	<td><b>Fax</b></td>
    <td>
    	<input type="text" name="fax" id="fax" class="form-control" value="<?php echo $fjfax; ?>"/>
    </td>
...
<tr>
    ...
    <td>
    	<input type="url" name="url" id="url" class="form-control" value="<?php echo $fjonline; ?>"/>
    </td>
...
<tr>
    ...
    <td>
    	<input type="email" name="email" id="email" class="form-control" value="<?php echo $fjemail; ?>"/>
    </td>
...
<tr>
    ...
    <td>
    	<input type="text" name="keywords" id="keywords" class="form-control" onBlur="jobKeywords()" value="<?php echo $fjkeywords; ?>"/>
...
<tr>
	<td></td>
	<td>
        <input type="submit" name="update" class="btn btn-default" value="Update &raquo;" />
    </td>
    <td>&nbsp;</td>
</tr>
</tbody>
