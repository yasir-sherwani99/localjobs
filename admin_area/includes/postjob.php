<form method="post" action="add_jobs.php" role="form" onSubmit="return confirmSubmit()">
...
<tr>
	<td>Job Country<span style="color: #F00; font-size: 16px;">&nbsp;*</span></td>
    <td>
...
<tr>
	<td>Employment Status<span style="color: #F00; font-size: 16px;">&nbsp;*</span></td>
    <td>
...
<tr>
	<td>Company Name</td>
    <td>
        <select name="comp_name" id="comp_name" class="form-control" >
            <option value="-1">Company</option>
            <?php
                $get_comp = "select * from employers";
