    ...
    <div id="contents" class="col-md-9">
    	...
    	<div id="tab" class="row">
        	<ul class="nav nav-tabs">
            	<li class="active" style="font-weight: bold;"><a href="jobs.php">Jobs</a></li>
                <li><a href="add_jobs.php">Post Job</a></li>
            </ul>
        </div>
        <div id="search_job" style="background-color: #FFF; height: 30px; border: hidden;" class="row">
            ...
            <button class="btn btn-default pull-right" disabled="disabled">Total Jobs: <span class="badge"><?php echo totalJobs(); ?></span></button>
        </div>
        <?php
        	...
        	<table class="table table-bordered">
			 ...
			 if($today > $expire){
			      ...
			      echo "<td style='color: green; font-weight: bold;'>Active</td>";
                    ...
                    ?>
                    <td style="text-align: center;"><span class="badge"><?php echo countLatestApps($job_id); ?></span></td>
                    <td><a href="edit_job.php?job_id=<?php echo $job_id; ?>"><button class="btn btn-default btn-xs"><img src="images/pencil.png" width="10" height="10"></button></a></td>
                    <td><a href="delete_job.php?job_id=<?php echo $job_id; ?>" onClick="return confirm('Are you sure, you want to delete this Job??')"><button class="btn btn-default btn-xs"><img src="images/cross.png" width="10" height="10"></button></a></td>
                </tr>
                </tbody>
