    ...
    <div id="contents" class="col-md-9">
    	...
    	<div id="tab" class="row">
        	<ul class="nav nav-tabs">
            	<li class="active" style="font-weight: bold;"><a href="walkin.php">Walkin Interviews</a></li>
        ...
        <div id="search_job" style="background-color: #FFF; height: 30px; border: hidden;" class="row">
            ...
            <button class="btn btn-default pull-right" disabled="disabled">Total Jobs: <span class="badge"><?php echo totalWalkinJobs(); ?></span></button>
        </div>
        <?php
          ...
          <div class="table-responsive">	
        	<table class="table table-bordered">
				...
				while($row_jobs = mysqli_fetch_array($results)){
						...
						$expiry_day = $row_jobs['winterview_day'];
						$expiry_month = $row_jobs['winterview_month'];
						$expiry_year = $row_jobs['winterview_year'];
            ...
            ?>       
                    ...
                    ?>
                    <td><a href="edit_walkin.php?job_id=<?php echo $job_id; ?>"><button class="btn btn-default btn-xs"><img src="images/pencil.png" width="10" height="10"></button></a></td>
                    <td><a href="delete_walkin.php?job_id=<?php echo $job_id; ?>" onClick="return confirm('Are you sure, you want to delete this Job??')"><button class="btn btn-default btn-xs"><img src="images/cross.png" width="10" height="10"></button></a></td>
                </tr>
                </tbody>
