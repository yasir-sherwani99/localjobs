<?php
	...
	function totalWalkinJobs(){
		global $conn;
		$query = "SELECT * FROM walk_interview";
		$run = mysqli_query($conn, $query);
		$total_records = mysqli_num_rows($run);
		return $total_records;
	}
	
	function totalInternships(){
		global $conn;
	...
	function totalForeignJobs(){
		global $conn;
		$query = "SELECT * FROM foreign_jobs";
		$run = mysqli_query($conn, $query);
		$total_records = mysqli_num_rows($run);
		return $total_records;
	}
	...
	function totalQuickApps(){
		global $conn;
		$query = "SELECT * FROM quick_apply";
		$run = mysqli_query($conn, $query);
		$total_records = mysqli_num_rows($run);
		return $total_records;
	}
