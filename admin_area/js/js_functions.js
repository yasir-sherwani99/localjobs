...
// JavaScript Functions for Members Validation
	...
	*/
		if(email == ""){
			...
			document.getElementById("correct1").innerHTML = "<img src='images/icons2/checkmark2.png' style='width: 20px; height:18px;'>";
			return true;
		}
	...
	function cityCheck(){
		...
		if(city == -1){
			...
			document.getElementById("error30").innerHTML = "<img src='images/checkmark2.png' style='width: 20px; height:18px;'>";
			return true;
		}
	...
	function othercityCheck(){
		...
		if(other_city == ""){
			...
			document.getElementById("correct9").innerHTML = "<img src='images/icons2/checkmark2.png' style='width: 20px; height:18px;'>";
			return true;
		}
	...
	*/
	...
	function degreeCheck(){
		...
		if(degree == -1){
			document.getElementById("error10").innerHTML = "Highest degree required";
			return false;
		}
		else{
	...
	function degreeTitleCheck(){
		...
		if(title == ""){
			document.getElementById("error11").innerHTML = "Degree title required";
			return false;
		}
		else{
	...
	function majorsCheck(){
		...
		if(major == ""){
			document.getElementById("error12").innerHTML = "Major Subjects required";
			return false;
		}
		else{
	...
	function educityCheck(){
		...
		if(icity == ""){
			...
			document.getElementById("error46").innerHTML = "<img src='images/checkmark2.png' style='width: 20px; height:18px;'>";
			return true;
		}
	...
	function eduInsCheck(){
		...
		if(inst == ""){
			document.getElementById("error14").innerHTML = "Institute name required";
			return false;
		}
		else{
...
*/
		if(exp == -1){
			...
			document.getElementById("error16").innerHTML = "<img src='images/checkmark2.png' style='width: 20px; height:18px;'>";
			return true;
		}
	}
	...
	function industryCheck(){
		...
		if(industry == -1){
			document.getElementById("error18").innerHTML = "Industry is required";
			return false;
		}
		else{
			document.getElementById("error18").innerHTML = "<img src='images/checkmark2.png' style='width: 20px; height:18px;'>"
			return true;
		}
	...
	function currentJob(){
		...
		if(curr_job == ""){
			document.getElementById("error20").innerHTML = "Present Job required";
			return false;
		}
		else{
	...
	function jobperiodCheck(){
		...
		if(endyear == -1){
			...
			document.getElementById("error21").innerHTML = "<img src='images/checkmark2.png' style='width: 20px; height:18px;'>";
			return true;
		}
	}
	...
	function companyCheck(){
		...
		if(comp == ""){
			...
			document.getElementById("error22").innerHTML = "<img src='images/checkmark2.png' style='width: 20px; height:18px;'>";
			return true;
		}
	...
	function compctryCheck(){
		...
		if(cctry == -1){
			...
			document.getElementById("error23").innerHTML = "<img src='images/checkmark2.png' style='width: 20px; height:18px;'>";
			return true;
		}
	...
	function compctryCheck(){
		...
		if(ccity == ""){
			...
			document.getElementById("error24").innerHTML = "<img src='images/checkmark2.png' style='width: 20px; height:18px;'>";
			return true;
		}
	...
	function resumeCheck(){
		...
		if(cv == ""){
			...
			document.getElementById("error25").innerHTML = "<img src='images/checkmark2.png' style='width: 20px; height:18px;'>";
			return true;
		}
