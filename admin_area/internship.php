    ...
    <div id="contents" class="col-md-9">
    	...
    	<div id="tab" class="row">
        	<ul class="nav nav-tabs">
            	<li class="active" style="font-weight: bold;"><a href="internship.php">Internships</a></li>
                <li><a href="add_internship.php">Post Internship</a></li>
            </ul>
        </div>
        <div id="search_job" style="background-color: #FFF; height: 30px; border: hidden;" class="row">
            ...
            <button class="btn btn-default pull-right" disabled="disabled">Total Jobs: <span class="badge"><?php echo totalInternships(); ?></span></button>
        </div>
        <?php
          ...
          <div class="table-responsive">	
        	<table class="table table-bordered">
				...
				//		$job_ctry = $row_jobs['for_job_ctry'];
						$expiry_day = $row_jobs['intern_exp_day'];
						$expiry_month = $row_jobs['intern_exp_month'];
						$expiry_year = $row_jobs['intern_exp_year'];
                ...
                <tr>
                   ...
                   <!-- <td><?php //echo $ctry_title; ?></td>  -->
                    ...
                    <td><a href="delete_internship.php?job_id=<?php echo $job_id; ?>" onClick="return confirm('Are you sure, you want to delete this Job??')"><button class="btn btn-default btn-xs"><img src="images/cross.png" width="10" height="10"></button></a></td>
                </tr>
                </tbody>
