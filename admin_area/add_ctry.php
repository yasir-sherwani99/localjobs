    ...
    <div id="contents" class="col-md-9">
    	<div id="tab" class="row">
        	<ul class="nav nav-tabs">
                ...
                <li class="active" style="font-weight: bold;"><a href="opt_ctry.php">Add Country</a></li>
        ...
        <?php
			if(isset($_GET['mess'])){
				...
				echo "<div id='message' class='alert alert-info'>
        				<img src='images/info.png' width='45' height='45'/>
            		  <div id='aa'><b>Add new country</b><br/>Enter the required fields and add a new country.						</div>
        		</div>";
			}
        ?>
        <div id="job_form" class="row">
        	<form name="" action="add_ctry.php" role="form" method="post">
            	<table class="table">
                <tbody>
				<tr>
                ...
                <tr>
                	<td></td>
                    <td><input type="submit" name="submit" class="btn btn-default" value="Add Country" /></td>
                </tr>
                </tbody>
				</table>
            </form>
...
<?php
	if(isset($_POST['submit'])){
		$ctry_name = cleanStr($_POST['title']);
		
		$insert_ctry = "INSERT INTO countries(ctry_name) VALUES('$ctry_name')";			
		$run_ctry = mysqli_query($connection, $insert_ctry);
		if($run_ctry){
			echo "<script>window.open('add_ctry.php?mess=A new country has entered successfully...!', '_self')</script>";
		}else{
