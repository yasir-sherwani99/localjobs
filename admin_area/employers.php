    ...
    <div id="contents" class="col-md-9">
    	<div id="tab" class="row">
        	<ul class="nav nav-tabs">
            	<li class="active" style="font-weight: bold;"><a href="employers.php">Employers</a></li>
                <li><a href="add_employers.php">Add Employers</a></li>
            </ul>
        </div>
        <div id="search_job" style="background-color: #FFF; height: 30px; border: hidden;" class="row">
            ...
            <button class="btn btn-default pull-right" disabled="disabled">Total Employers <span class="badge"><?php echo totalEmployers(); ?></span></button>
        </div>
        <?php
        ...
        <div id="all_jobs" style="height:background-color:#FFF; font-size: 14px;" class="row">
          <div class="table-responsive">	
        	<table border="0" class="table table-bordered">
				...
				$statement = "employers ORDER BY creation_date DESC"; // Change `records` according to your table name.
				...
				while($row_jobs = mysqli_fetch_array($results)){
						...
						$comp_email = $row_jobs['comp_email'];
						$comp_name = $row_jobs['comp_name'];
						$comp_status = $row_jobs['status'];
						$comp_logo = $row_jobs['comp_logo'];
                ...
                <tr>
                    ...
                    <td align="center">
                    	<?php
				if($comp_logo == ""){
					echo "<img src='../employers/company_logo/no_log.png' width='30' height='30' />";		
				}
				else{
					echo "<img src='../employers/company_logo/$comp_logo' width='30' height='30' />"; 
				}
			?>
                    </td>
                    <td><?php echo $comp_status; ?></td>
                    <td style="text-align: center;"><span class="badge"><?php echo countEmployerJobs($comp_id); ?></span></td>
                    <td><a href="edit_employer.php?comp_id=<?php echo $comp_id; ?>"><button class="btn btn-default btn-xs"><img src="images/pencil.png" width="10" height="10"></button></a>
                    <a href="delete_employer.php?comp_id=<?php echo $comp_id; ?>" onClick="return confirm('Are you sure, you want to delete this Employer??')"><button class="btn btn-default btn-xs"><img src="images/cross.png" width="10" height="10"></button></a></td>
                </tr>
